...
import com.edge.greasy.subscription.IabBroadcastReceiver;
import com.edge.greasy.subscription.IabBroadcastReceiver.IabBroadcastListener;
import com.edge.greasy.subscription.IabHelper;
import com.edge.greasy.subscription.IabHelper.IabAsyncInProgressException;
import com.edge.greasy.subscription.IabResult;
import com.edge.greasy.subscription.Inventory;
import com.edge.greasy.subscription.Purchase;
 ...
 */
public class SubscriptionActivity extends Activity implements IabBroadcastListener,
        OnClickListener {
    // Debug tag, for logging
    static final String TAG = "GREasy";
    ...
    static final String SKU_INFINITE_GAS_MONTHLY = "subscription_one_month";
    static final String SKU_INFINITE_GAS_HALF_YEARLY = "subscription_six_months";
    static final String SKU_INFINITE_GAS_YEARLY = "subscription_twelve_months";
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = "";

        // Some sanity checks to see if the developer (that's you!) really followed the
        // instructions to run this sample (don't put these checks on your app!)
        if (base64EncodedPublicKey.contains("CONSTRUCT_YOUR")) {
            throw new RuntimeException("Please put your app's public key in SubscriptionActivity.java. See README.");
        }
    ...
    IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
            ...
            Purchase gasHalfYearly = null;
            Purchase gasMonthly = null;

            gasYearly = inventory.getPurchase(SKU_INFINITE_GAS_YEARLY);
            if (gasYearly != null) {
                mSubscriptionCurrent = SKU_INFINITE_GAS_YEARLY;
                mAutoRenewEnabled = gasYearly.isAutoRenewing();
            } else{
                gasHalfYearly = inventory.getPurchase(SKU_INFINITE_GAS_HALF_YEARLY);
                if (gasHalfYearly != null) {
                    mSubscriptionCurrent = SKU_INFINITE_GAS_HALF_YEARLY;
                    mAutoRenewEnabled = gasHalfYearly.isAutoRenewing();
                } else {
                    gasMonthly = inventory.getPurchase(SKU_INFINITE_GAS_MONTHLY);
                    if (gasMonthly != null) {
                        mSubscriptionCurrent = SKU_INFINITE_GAS_MONTHLY;
                        mAutoRenewEnabled = gasMonthly.isAutoRenewing();
                    } else {
                        mSubscriptionCurrent = null;
            ...
            // renewing
            mSubscribedToInfiniteGas = mSubscriptionCurrent != null;
    ...
    public void onInfiniteGasButtonClicked(View arg0) {
        ...
        if (!mSubscribedToInfiniteGas || !mAutoRenewEnabled) {
            ...
            options[1] = getString(R.string.subscription_period_half_yearly);
            options[2] = getString(R.string.subscription_period_yearly);

            mFirstChoiceSku = SKU_INFINITE_GAS_MONTHLY;
            mSecondChoiceSku = SKU_INFINITE_GAS_HALF_YEARLY;
            ...
            if (mSubscriptionCurrent.equals(SKU_INFINITE_GAS_MONTHLY)) {
                // Give the option to upgrade to yearly
                options[0] = getString(R.string.subscription_period_half_yearly);
                options[1] = getString(R.string.subscription_period_yearly);
                mFirstChoiceSku = SKU_INFINITE_GAS_HALF_YEARLY;
    ...
    public void onClick(DialogInterface dialog, int id) {
        if (id == 0 /* First choice item */) {
            ...
            if (!TextUtils.isEmpty(mSubscriptionCurrent)
                    && !mSubscriptionCurrent.equals(mSelectedSubscriptionPeriod)) {
                // The user currently has a valid subscription, any purchase action is going to
                // replace that subscription
                oldSkus = new ArrayList<String>();
                oldSkus.add(mSubscriptionCurrent);
            }
        ...
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            ...
            if (purchase.getSku().equals(SKU_GAS)) {
                ...
                setWaitScreen(false);
                    ...
                    || purchase.getSku().equals(SKU_INFINITE_GAS_HALF_YEARLY)
                ...
                mSubscriptionCurrent = purchase.getSku();
                mTank = TANK_MAX;
                updateUi();
                setWaitScreen(false);
            }
    ...
    void complain(String message) {
        Log.e(TAG, "**** GREasy Error: " + message);
        alert("Error: " + message);
    }
