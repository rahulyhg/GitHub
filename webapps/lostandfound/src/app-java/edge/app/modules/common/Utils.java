...
public class Utils {
	...
	public static String deriveMatchingKey(LostRequest lostRequest) {
		...
		case UNIQUE_ID: returnValue = lostRequest.getUniqueIdType() + "_" + lostRequest.getUniqueId(); break;
	...
	public static String deriveMatchingKey(FoundRequest foundRequest) {
		...
		case UNIQUE_ID: returnValue = foundRequest.getUniqueIdType() + "_" + foundRequest.getUniqueId(); break;
